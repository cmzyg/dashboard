...
<link href="<?php echo $view['assets']->getUrl('css/simple-line-icons.min.css') ?>" rel="stylesheet" type="text/css" />

<link href="<?php echo $view['assets']->getUrl('css/bootstrap.min.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/uniform.default.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/bootstrap-switch.min.css') ?>" rel="stylesheet" type="text/css" />

<link href="<?php echo $view['assets']->getUrl('css/daterangepicker-bs3.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/fullcalendar.min.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/jqvmap.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/tasks.css') ?>" rel="stylesheet" type="text/css" />

<link href="<?php echo $view['assets']->getUrl('css/components.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/plugins.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/layout.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/grey.css') ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo $view['assets']->getUrl('css/custom.css') ?>" rel="stylesheet" type="text/css" />
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="<?php echo $view['assets']->getUrl('img/logo-default.png'); ?>" alt="logo" class="logo-default"/>
			</a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									<li>
										...
										<span class="photo">
										<img src="<?php echo $view['assets']->getUrl('img/avatar2.jpg'); ?>" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="<?php echo $view['assets']->getUrl('img/avatar3.jpg'); ?>" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="<?php echo $view['assets']->getUrl('img/avatar1.jpg'); ?>" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
					...
					<li class="dropdown dropdown-user">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="<?php echo $view['assets']->getUrl('img/avatar3_small.jpg'); ?>" />
						...
						<div class="portlet light ">
							...
							<div class="portlet-body">
								<div id="site_statistics_loading">
									<img src="<?php echo $view['assets']->getUrl('img/loading.gif'); ?>" alt="loading"/>
								</div>
						...
						<div class="portlet light ">
							...
							<div class="portlet-body" id="chats">
								<div class="scroller" style="height: 353px;" data-always-visible="1" data-rail-visible1="1">
									<ul class="chats">
										<li class="in">
											<img class="avatar" alt="" src="<?php echo $view['assets']->getUrl('img/avatar1.jpg'); ?>"/>
											<div class="message">
												<span class="arrow">
												</span>
										...
										<li class="out">
											<img class="avatar" alt="" src="<?php echo $view['assets']->getUrl('img/avatar2.jpg'); ?>"/>
											<div class="message">
												<span class="arrow">
												</span>
												<a href="javascript:;" class="name">
										...
										<li class="out">
											<img class="avatar" alt="" src="<?php echo $view['assets']->getUrl('img/avatar3.jpg'); ?>"/>
											<div class="message">
												<span class="arrow">
												</span>
												<a href="javascript:;" class="name">
								...
								<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar3.jpg'); ?>" alt="...">
										...
										<li class="media">
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar1.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar4.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar2.jpg'); ?>" alt="...">
											<div class="media-body">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar6.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src=".<?php echo $view['assets']->getUrl('img/avatar7.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar8.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar9.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar10.jpg'); ?>" alt="...">
											<div class="media-body">
										...
										<li class="media">
											...
											<img class="media-object" src="<?php echo $view['assets']->getUrl('img/avatar11.jpg'); ?>" alt="...">
											<div class="media-body">
...
<![endif]-->
<script src="<?php echo $view['assets']->getUrl('js/jquery.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery-migrate.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery-ui.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/bootstrap.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/bootstrap-hover-dropdown.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.slimscroll.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.blockui.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.cokie.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.uniform.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/bootstrap-switch.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.russia.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.world.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.europe.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.germany.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.usa.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.vmap.sampledata.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.flot.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.flot.resize.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.flot.categories.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.pulsate.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/moment.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/daterangepicker.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/fullcalendar.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.easypiechart.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/jquery.sparkline.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/metronic.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/layout.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/quick-sidebar.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/demo.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/index.js'); ?>" type="text/javascript"></script>
<script src="<?php echo $view['assets']->getUrl('js/tasks.js'); ?>" type="text/javascript"></script>
